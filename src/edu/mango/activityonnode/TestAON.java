...
public class TestAON {
	public static void main(String[] args) {
		...
		// System.out.println(node.getName() + " " + node.getEarliestStartTime()
		// + " " + node.getEarliestFinishTime());
		// System.out.println(" " + node.getLatestStartTime() + " " +
		// node.getLatestFinishTime());
		...
		while (!exit) {
			...
			try {
				...
				case 4:
					for (ActivityNode node : project.getActivities()) {
						System.out.println(node.getName() + " EST:" + node.getEarliestStartTime() + " EFT:"
								+ node.getEarliestFinishTime());
						System.out.println("  LST:" + node.getLatestStartTime() + " LFT:" + node.getLatestFinishTime());
				...
				case 5:
					...
					System.out.println("Critical path duration: " + critPath.get(critPath.size() - 1).getLatestFinishTime());
					break;
				case 6:
